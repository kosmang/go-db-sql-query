...
func main() {
	...
	newClient := Client{
		FIO:      "Косман Газиз Саматулы", // укажите ФИО
		Login:    "gkosman",               // укажите логин
		Birthday: "20021205",              // укажите день рождения
		Email:    "kosman2002@mail.ru",    // укажите почту
	}
	...
	newLogin := "kosman2002" // укажите новый логин
